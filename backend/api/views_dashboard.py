...
def dashboard_stats(request):
    ...
    Returns:
    - total_emissions: Total emissions across all projects (tCO₂e)
    ...
    try:
        ...
        monthly_data = calculate_monthly_emissions(start_date, end_date, months_back)
        
        # Emissions by scope
        emissions_by_scope = calculate_emissions_by_scope()
...
def calculate_monthly_emissions(start_date, end_date, months_back):
    """
...
def calculate_emissions_by_scope():
    """
